...
[lead]
This message occurs when a management command or file operation tries to generate an audit record, that is greater than the max_audit_record_size value.
