...
[lead]
This message occurs when a metadata inconsistency is discovered inside a file system feature that is read-only and therefore cannot be immediately corrected.
