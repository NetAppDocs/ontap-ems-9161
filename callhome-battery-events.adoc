...
[lead]
This message occurs when the battery is either incapable of maintaining data during a power-outage, or is experiencing a failure that poses a physical threat.
