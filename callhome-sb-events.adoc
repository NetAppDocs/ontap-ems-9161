...
[lead]
This message occurs when the persistent port feature is not working during non-disruptive operations (NDO) such as takeover or giveback due to configuration errors.
