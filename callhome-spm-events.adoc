...
[lead]
This message occurs when a subsystem is not fully operational after one or more restarts and a restart threshold has been reached by the Service Process Manager (SPM).
