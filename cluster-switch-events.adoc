...
[.lead]
cluster.switch events are presented when cluster switch issues are detected, including insufficient switches for redundancy, power supply failures, unexpected reboots, and unsupported switch models, which may require verifying switch connectivity and configuration.
