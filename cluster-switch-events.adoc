...
[.lead]
cluster.switch EMS events occur when ONTAP encounters issues associated with cluster switch health, including switch redundancy, power supply status, unexpected reboots, and supported switch models.
