...
[.lead]
coredump.long events are presented when the coredump manager detects messages that have been queued or processed longer than an internal threshold, though no corrective action is required.
