...
[lead]
This message occurs when the software disk ownership module notifies other layers that it has completed the process of updating its view of the disks attached to the system.
