...
[lead]
This message occurs when the Fibre Channel fabric cannot successfully complete a request to the Management Server to retrieve configuration information.
