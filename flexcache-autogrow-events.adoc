...
[.lead]
flexcache.autogrow events are presented when automatic growth of a FlexCache volume fails because the total cluster-wide FlexCache provisioned space has exceeded the licensed limit, which can be resolved by installing a new license.
