...
[.lead]
flexcache.autogrow EMS events occur when automatic growth of a FlexCache volume fails because the total cluster-wide FlexCache provisioned space has exceeded the licensed limit.
