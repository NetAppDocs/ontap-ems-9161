...
[.lead]
flexcache.capacity events are presented when the total cluster-wide FlexCache provisioned space has exceeded the licensed limit, which can be resolved by installing a new license.
