...
[.lead]
flexcache.nearly events are presented when the total cluster-wide FlexCache provisioned space has nearly reached the licensed limit, which can be resolved by installing a new license to increase capacity.
