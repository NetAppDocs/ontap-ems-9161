...
[lead]
This message occurs when the size of the panic information received from the high-availability (HA) partner is not equal to the expected panic information size.
