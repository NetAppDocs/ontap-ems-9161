...
[lead]
This message occurs when a 'volume move' operation finishes moving the volume to the destination but fails to update the appropriate information on the destination.
