...
[lead]
This message occurs when a critical system resource required for Data ONTAP(R) to continue serving data cannot be allocated for an extended period of time.
