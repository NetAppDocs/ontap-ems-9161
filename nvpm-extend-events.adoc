...
[lead]
This message occurs when nvlog client segments cannot be enabled in a partner NVRAM section following a controller failover or MetroCluster(R) switchover.
