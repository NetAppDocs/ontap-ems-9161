...
[lead]
This message occurs after the administrator uses the "volume quota on" command, when the quota scanner aborts without finishing due to an error condition.
