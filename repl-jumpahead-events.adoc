...
[lead]
This message occurs when the system cannot bring a replica volume online after applying the latest update to the replica because of possible inconsistencies detected in the update.
