...
[lead]
This message occurs when Enclosure Services in the storage system cannot establish contact with the enclosure monitoring process in any disk shelf on the channel.
