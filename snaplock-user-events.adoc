...
[lead]
This message occurs when the SnapLock(R) logging system fails to securely log either the addition or deletion of the compliance admin role to or from a user account.
