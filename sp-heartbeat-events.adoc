...
[lead]
This event is generated when the appliance detects resumption of Service Processor (SP) heartbeat notifications indicating that the Service Processor is now available.
