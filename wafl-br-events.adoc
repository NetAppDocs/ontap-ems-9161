...
[lead]
This event is issued if block reallocation has not been performed on an aggregate but a reallocated block was found that subsequently needs to be redirected.
