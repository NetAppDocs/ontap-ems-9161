...
[.lead]
wafl.dosname events are presented when the system cannot correct duplicate dosnames in a directory, which can be resolved by renaming problematic files from an NFS client and running the wafl dosname command.
