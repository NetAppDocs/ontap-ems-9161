...
[lead]
This message occurs when the system cannot perform an aggregate relocation because one or more of its volumes are used by wafliron to host status files.
