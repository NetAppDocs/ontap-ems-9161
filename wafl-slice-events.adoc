...
[lead]
This message occurs when an invalid slice stream was not fixed by wafliron because the associated slice base file was not recognized at the time wafliron ran.
